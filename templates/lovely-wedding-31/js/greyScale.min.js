    ...
    a.fn.greyScale = function(c) {
        ...
        if (a.browser.msie) {
            this.each(function() {
                ...
                a(this).css({
                    filter: "progid:DXImageTransform.Microsoft.BasicImage(grayscale=" + d + ")",
                    zoom: "1"
                });
                a(this).hover(function() {
                    var e = $options.reverse ? 1 : 0;
                    a(this).css({
                        filter: "progid:DXImageTransform.Microsoft.BasicImage(grayscale=" + e + ")"
                    })
                }, function() {
            ...
            a(this).parent().delegate(".gsCanvas", "mouseover mouseout", function(d) {
                ...
                (d.type == "mouseover") && a(this).stop().animate({
                    opacity: over
                }, $options.fadeTime);
                (d.type == "mouseout") && a(this).stop().animate({
                    opacity: out
                }, $options.fadeTime)
            })
        }
...
(function(X, V) {
    ...
    var d = "async",
        ...
        F = "timeout",
        f = X.browser,
        R = X("head")[0] || document.documentElement,
        z = {},
        b = 0,
        E, B = {
            callback: k,
